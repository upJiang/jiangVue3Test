<template>
  <div class="container">
    ...
    <div class="oprate-item">
      ...
      ></a-input>
      <a-button @click="onFindGoods" class="find-btn" type="primary"
        >查找藏品</a-button
      >
    </div>
    <span v-if="goodsId"
      >已为您查找到该藏品：{{ goodsName }}，您可点击发起锁单</span
    >
    ...
    <a-button @click="onSend" class="btn" type="primary" :loading="isLoading"
      >发起锁单</a-button
    >
    <a-button @click="onStop" class="btn" style="margin-left: 20px"
      >停止锁单</a-button
    >
    <div style="color: grey; margin-top: 4px">
      {{
